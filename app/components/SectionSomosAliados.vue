<template>
    <section class="bg-green-dark py-12 lg:py-16 xxl:px-32">
        ...
        <div class="xxl:max-w-[75rem] w-full flex flex-col items-center gap-5 md:gap-6 xxl:mx-auto">
                    ...
                    <button ref="cardRef" @touchstart="handleTouchStart" @touchend="handleTouchEnd"
                        ...
                        <div class="relative flex gap-3 items-center min-w-0 flex-1">
                            ...
                            <div>
                                ...
                                <p class="w-fit text-xs lg:text-sm text-green-dark lg:mt-1"
                                    :class="isCompleted ? 'font-bold' : 'font-normal'">
                                    {{ isCompleted ? 1 : 0 }}/1
                                </p>
                            </div>
                        </div>
            ...
            <div class="w-full flex flex-col gap-3 lg:gap-4 lg:px-16 xxl:px-0">
                ...
                <Carousel :slidesPerView="{ base: 2.3, sm: 3.3, md: 5.6, lg: 7, xl: 7, xxl: 7 }" :gap="8"
                    :showArrows="{ base: false, lg: true, xl: true, xxl: true }" :showDots="false"
                    ...
                    <div v-for="brand in brands" :key="brand.id"
                        ...
                        <NuxtImg v-if="brand.image_url" :src="brand.image_url" :alt="brand.name"
                            class="w-full h-9 sm:h-12 md:h-11 xxl:h-[52px] object-contain" />
